...
define([
    ...
    var CTConstants = function () {
       ...
       // Config Editor Constants
        ...
        //virtual-network mapping constants
        this.VIRTUAL_NETWORK_TEMP_MAPPING = [
            { schemaKey :'name',label: 'Name',key:'name',formatter: 'objectKeyFormatter'},
            { schemaKey :'display_name',label: 'Display Name',key:'display_name',formatter: 'objectKeyFormatter'},
            { schemaKey :'uuid',label: 'UUID',key:'uuid',formatter: 'objectKeyFormatter'},
            { schemaKey :'address_allocation_mode',label: 'Allocation Mode',key:'uuid',formatter: 'allocationModeExpFormatter' },
            { schemaKey :'network_ipam_refs',label: 'Subnet(s)',key:'uuid',formatter: 'subnetTmplFormatter'},
            { schemaKey :'id_perms',label: 'Admin State',key:'id_perms.enable',formatter: 'adminStateFormatter'},
            { schemaKey :'external_ipam',label: 'Static IP Addressing',key:'external_ipam',formatter: 'staticIPAddressingFormatter'},
            { schemaKey :'is_shared',label: 'Shared',key:'uuid',formatter: 'sharedFormatter'},
            { schemaKey :'router_external',label: 'External',key:'uuid',formatter: 'rtrExternalFormatter'},
            { schemaKey :'network_policy_refs',label: 'Attached Network Policies',key:'uuid',formatter: 'polColFormatter'},
            { schemaKey :'virtual_network_properties.forwarding_mode',label: 'Forwarding Mode',key:'uuid',formatter: 'fwdModeFormatter'},
            { schemaKey :'virtual_network_properties.vxlan_network_identifier',label: 'VxLAN Identifier',key:'uuid',formatter: 'vxLanIdFormatter'},
            { schemaKey :'virtual_network_properties.allow_transit',label: 'Allow Transit',key:'uuid',formatter: 'allowTransitFormatter'},
            { schemaKey :'virtual_network_properties.mirror_destination',label: 'Mirroring',key:'uuid',formatter: 'mirrorDestinationFormatter'},
            { schemaKey :'virtual_network_properties.rpf',label: 'Reverse Path Forwarding',key:'uuid',formatter: 'rpfFormatter'},
            { schemaKey :'flood_unknown_unicast',label: 'Flood Unknown Unicast',key:'uuid',formatter: 'floodUnUcastFormatter'},
            { schemaKey :'multi_policy_service_chains_enabled',label: 'Multiple Service Chains',key:'uuid',formatter: 'multiSvcChainFormatter'},
            { schemaKey :'network_ipam_refs',label: 'Host Route(s)',key:'uuid',formatter: 'subnetHostRouteFormatter'},
            { schemaKey :'network_ipam_refs',label: 'DNS Server(s)',key:'uuid',formatter: 'subnetDNSFormatter'},
            { schemaKey :'ecmp_hashing_include_fields',label: 'Ecmp Hashing Fields',key:'uuid',formatter: 'ecmpHashFormatter'},
            { schemaKey :'provider_properties',label: 'Provider Network',key:'uuid',formatter: 'sriovFormatter'},
            { schemaKey :'physical_router_back_refs',label: 'Extended to Physical Router(s)',key:'uuid',formatter: 'phyRouterFormatter'},
            { schemaKey :'route_table_refs',label: 'Attached Static Route(s)',key:'uuid',formatter: 'staticRouteFormatter'},
            { schemaKey :'floating_ip_pools',label: 'Floating IP Pool(s)',key:'uuid',formatter: 'fipPoolTmplFormatter'},
            { schemaKey :'route_target',label: 'Route Target(s)',key:'route_target_list',formatter: 'routeTargetFormatter'},
            { schemaKey :'export_route_target_list',label: 'Export Route Target(s)',key:'export_route_target_list',formatter: 'exportRouteTargetFormatter'},
            { schemaKey :'import_route_target_list',label: 'Import Route Target(s)',key:'import_route_target_list',formatter: 'importRouteTargetFormatter'},
            { schemaKey :'qos_config_refs',label: 'QoS',key:'qos_config_refs',formatter: 'QoSFormatter'},
            { schemaKey :'pbb_evpn_enable',label: 'PBB Encapsulation',key:'pbb_evpn_enable',formatter: 'PBBEvpnFormatter'},
            { schemaKey :'pbb_etree_enable',label: 'PBB ETree',key:'pbb_etree_enable',formatter: 'PBBETreeFormatter'},
            { schemaKey :'layer2_control_word',label: 'Layer2 Control Word',key:'layer2_control_word',formatter: 'Layer2CWFormatter'},
            { schemaKey :'mac_learning_enabled',label: 'MAC Learning',key:'mac_learning_enabled',formatter: 'MACLearningFormatter'},
            { schemaKey :'mac_limit_control',label: 'MAC Limit',key:'mac_limit_control.mac_limit',formatter: 'objectKeyFormatter'},
            { schemaKey :'mac_limit_control',label: 'MAC Limit Action',key:'mac_limit_control.mac_limit_action',formatter: 'objectKeyFormatter'},
            { schemaKey :'mac_move_control',label: 'MAC Move Limit',key:'mac_move_control.mac_move_limit',formatter: 'objectKeyFormatter'},
            { schemaKey :'mac_move_control',label: 'MAC Move Limit Action',key:'mac_move_control.mac_move_limit_action',formatter: 'objectKeyFormatter'},
            { schemaKey :'mac_move_control',label: 'MAC Move Time Window',key:'mac_move_control.mac_move_time_window',formatter: 'MACMoveTimeWindowFormatter'},
            { schemaKey :'mac_aging_time',label: 'MAC Aging Time',key:'mac_aging_time',formatter: 'MACAgingTimeFormatter'},
            { schemaKey :'qos_config_refs',label: 'Bride Domains',key:'bridge_domains',formatter: 'BridgeDomainFormatter'},
            { schemaKey :'tag_refs',label: 'Associated Tags',key:'tag_refs',formatter: 'objectKeyFormatter'}];
        
        //Port mapping constants
        this.PORT_TEMP_MAPPING = [
            { schemaKey :'name',label: 'Name',key:'name',formatter: 'objectKeyFormatter'},
            { schemaKey :'display_name',label: 'Display Name',key:'display_name',formatter: 'objectKeyFormatter'},
            { schemaKey :'uuid',label: 'UUID',key:'uuid',formatter: 'objectKeyFormatter'},
            { schemaKey :'virtual_network_refs',label: 'Network',key:'virtual_network_refs',formatter: 'networkFormater' },
            { schemaKey :'id_perms',label: 'Admin State',key:'id_perms.enable',formatter: 'AdminStateFormatter'},
            { schemaKey :'virtual_machine_interface_mac_addresses.mac_address',label: 'MAC Address',key:'virtual_machine_interface_mac_addresses.mac_address',formatter: 'objectKeyFormatter'},
            { schemaKey :'instance_ip_back_refs',label: 'Fixed IPs',key:'instance_ip_back_refs',formatter: 'fixedIPFormaterExpand'},
            { schemaKey :'floating_ip_back_refs',label: 'Floating IPs',key:'floating_ip_back_refs',formatter: 'floatingIPFormatter'},
            { schemaKey :'security_group_refs',label: 'Security Groups',key:'uuid',formatter: 'sgFormater'},
            { schemaKey :'virtual_machine_interface_dhcp_option_list.dhcp_option',label: 'DHCP Options',key:'virtual_machine_interface_dhcp_option_list.dhcp_option',formatter: 'objectKeyFormatter'},
            { schemaKey :'interface_route_table_refs',label: 'Static Routes',key:'interface_route_table_refs',formatter: 'staticRoutFormatter'},
            { schemaKey :'service_health_check_refs',label: 'Service Health Check',key:'service_health_check_refs',formatter: 'serviceHealthCheckFormatter'},
            { schemaKey :'qos_config_refs',label: 'QoS',key:'qos_config_refs',formatter: 'QoSFormatter'},
            { schemaKey :'virtual_machine_interface_properties.local_preference',label: 'Local Preference',key:'virtual_machine_interface_properties',formatter: 'localPrefFormater'},
            { schemaKey :'bridge_domain_refs',label: 'Bridge Domain',key:'bridge_domain_refs',formatter: 'BridgeDomainFormatter'},
            { schemaKey :'ecmp_hashing_include_fields',label: 'ECMP Hashing Fields',key:'ecmp_hashing_include_fields',formatter: 'ECMPHashingFormatter'},
            { schemaKey :'virtual_machine_interface_fat_flow_protocols.fat_flow_protocol',label: 'FatFlow',key:'virtual_machine_interface_fat_flow_protocols.fat_flow_protocol',formatter: 'objectKeyFormatter'},
            { schemaKey :'virtual_machine_interface_bindings.key_value_pair',label: 'Bindings',key:'virtual_machine_interface_bindings.key_value_pair',formatter: 'objectKeyFormatter'},
            { schemaKey :'virtual_machine_interface_allowed_address_pairs',label: 'Allowed address pairs',key:'virtual_machine_interface_allowed_address_pairs',formatter: 'AAPFormatter'},
            { schemaKey :'virtual_machine_interface_properties.interface_mirror',label: 'Mirroring',key:'uuid',formatter: 'mirrorFormatter'},
            { schemaKey :'virtual_machine_interface_refs',label: 'Sub Interfaces',key:'virtual_machine_interface_refs',formatter: 'childrensUUID'},
            { schemaKey :'virtual_machine_interface_properties.sub_interface_vlan_tag',label: 'Sub Interface VLAN',key:'uuid',formatter: 'subInterfaceVXLANUUID'},
            { schemaKey :'virtual_machine_interface_properties.sub_interface_vlan_tag',label: 'Parent Port',key:'uuid',formatter: 'parentUUIDFormatter'},
            { schemaKey :'virtual_machine_interface_disable_policy',label: 'Disable Policy',key:'virtual_machine_interface_disable_policy',formatter: 'disablePolicyFormatter'},
            { schemaKey :'virtual_machine_interface_device_owner',label: 'Device',key:'virtual_machine_interface_device_owner',formatter: 'deviceOwnerFormatter'},
            { schemaKey :'virtual_machine_interface_device_owner',label: 'Device ID',key:'virtual_machine_interface_device_owner',formatter: 'deviceUUIDFormatter'},
            { schemaKey :'tag_refs',label: 'Associated Tags',key:'tag_refs',formatter: 'objectKeyFormatter'}];
    };
